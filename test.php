...
<body>
    ...
    <table border="1px" class="table">
        ...
        <tr>
            ...
            <td class="dets lins"> <center> <?php echo "<a href='order_create.php?cid={$info['cid']}' class='rem'>ADD</a>"; ?>  </center></td>
            <td class="dets lins" ><center>  <?php echo "<a onClick=\" javascript:return confirm('Are you sure to delete?');\" href='customer_delete.php?cid={$info['cid']}' class='rem'>Remove</a>"; ?>  </td>
